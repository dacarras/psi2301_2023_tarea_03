...
- Empleando las respuestas a las tres preguntas (eng1, eng2 y eng3) de Compromiso (Engagement). Guarde los puntajes totales en una variable llamada "eng".

- Revise el texto de cada afirmación, y discrime que item habria que invertir.
...
- Inserte los códigos utilizados para crear la variable Engagement a partir de los ítems eng1, eng2 y eng3 que son parte del instrumento usado para estudiar esta variable. (Recuerde revisar si hay ítems inversos e invertirlos si corresponde).
...
## Ejercicio 5. Diagrama de dispersión entre la variable compromiso y la variable edad (age).
...
## Ejercicio 6. Regresión lineal simple prediciendo la variable compromiso en base al predictor Edad (age)

- Inserte los códigos utilizados para realizar una regresión lineal utilizando la variable compromiso como variable de respuesta y la variable Edad (age) como variable predictora.
